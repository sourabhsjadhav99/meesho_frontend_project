...
function Categories() {
 // Initializing useDispatch to dispatch actions
 const dispatch = useDispatch();

 // Initializing useNavigate for navigation within the app
 const navigate = useNavigate();

 // Function to handle play button click (opens Google Play URL)
 ...
 // Function to handle app button click (opens Apple App Store URL)
