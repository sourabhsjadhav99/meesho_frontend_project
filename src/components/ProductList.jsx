...
function ProductList() {
  ...
  useEffect(() => {
    dispatch(
      fetchProducts({ categories: selectedCategories, sort: sortOption, price:selectedPrices, ratings:selectedRatings })
    );
  }, [dispatch, selectedCategories, sortOption, selectedPrices, selectedRatings]);
